...
import { Bot, Terminal, Code2, ShieldCheck, Flame, Briefcase, Sparkles, CheckCircle2, ArrowRight, Zap, Star, Mail, GraduationCap } from 'lucide-react';
      ...
      <footer className="border-t border-slate-200/50 dark:border-slate-800/60 bg-white/50 dark:bg-slate-950/80 backdrop-blur-xl py-12 relative z-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center border-b border-slate-200/50 dark:border-slate-800/50 pb-8">
            ...
            {/* Ultra-Sleek & Vibrant DEV Profile Banner */}
            <div className="md:col-span-2 rounded-2xl p-4 sm:p-5 bg-gradient-to-r from-slate-950 via-slate-900 to-indigo-950/90 border border-emerald-500/50 shadow-xl shadow-emerald-500/15 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative overflow-hidden group hover:border-cyan-400/80 transition-all duration-300">
              <div className="absolute top-0 right-0 w-28 h-28 bg-gradient-to-br from-emerald-500/15 to-cyan-500/15 rounded-full blur-xl group-hover:scale-125 transition-transform" />

              <div className="flex items-center gap-3.5 relative z-10">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-400 via-cyan-500 to-indigo-600 text-white shadow-lg shadow-emerald-500/25 group-hover:scale-105 transition-transform shrink-0">
                  <Code2 className="w-5.5 h-5.5 text-white" />
                </div>
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2">
                    <h4 className="text-base font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-cyan-300 to-indigo-300 tracking-wider">
                      DEV
                    </h4>
                    <span className="text-[9px] font-black uppercase tracking-wider text-cyan-300 px-2 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/30">
                      Lead Architect
                    </span>
                  </div>
              ...
              <a
                ...
                className="px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 hover:from-emerald-400 hover:to-cyan-400 text-white text-xs font-black shadow-lg shadow-emerald-500/25 hover:scale-105 transition-all flex items-center gap-2 shrink-0 cursor-pointer relative z-10 border border-cyan-300/40"
              >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
            <p>© 2026 CareerOS Platform. Designed &amp; Engineered by <strong className="text-slate-300 font-black tracking-wider">DEV</strong>.</p>
